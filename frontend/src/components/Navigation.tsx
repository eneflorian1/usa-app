...
import { Settings, MessageCircle, User, Home, BarChart2, Bell } from 'lucide-react';

const navItems = [
  { href: '/', icon: Home, label: 'Home', showOnMobile: true },
  { href: '/agent', icon: User, label: 'Agent', showOnMobile: true },
  { href: '/whatsapp', icon: MessageCircle, label: 'WhatsApp', showOnMobile: true },
